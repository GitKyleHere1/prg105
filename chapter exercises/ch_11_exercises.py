...
def main():
    ...
    home = SingleFamilyHome(6, 1200, 1, 1, .25)

# 8) Display the data using the accessor methods
    print("Some details for the home:\n")
    print("Number of rooms:      {}".format(home.get_number_of_rooms()))
    print("Square feet:          {}".format(home.get_square_feet()))
    print("Number of floors:     {}".format(home.get_floors()))
    print("Garage spaces:        {}".format(home.get_garage_type()))
    print("Yard size (acres):    {}\n".format(home.get_yard_type()))
...
# The Mouse class is a subclass of the mammal class
class Mouse(Mammal):
    def __init__(self):
...
def main2():
    # Create a Mammal, Mouse, and Sheep object
    mammal = Mammal("average Mammal")
    mouse = Mouse()
    sheep = Sheep()

    # Display information about each mammal
