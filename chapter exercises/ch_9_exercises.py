...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', "John": "March 12", "Frank": "January 11", "Tom": "December 21"}
...
# 5) Use the keys method to print all the keys in miles_ridden
...
# 2) Create a set named days that contain the days of the week
